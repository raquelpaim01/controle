...
if (($_GET['acao'] === "update")&& $pessoa == 'fisica'){
    $sql = sprintf ("update fornecedor set razao_social = '%s', email =  '%s', cpf = '%d',  telefone = '%d', rua = '%s', numero = '%d', bairro = '%s', cep = '%d', cidade = '%s', estado = '%s'
...
if (($_GET['acao'] === "update")&& $pessoa == 'juridica'){
    $sql = sprintf ("update fornecedor set razao_social = '%s', email =  '%s', cnpj = '%d',  telefone = '%d', rua = '%s', numero = '%d', bairro = '%s', cep = '%d', cidade = '%s', estado = '%s'
