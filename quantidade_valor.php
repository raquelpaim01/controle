...
<html>
    ...
    <div class = imagem>
        <div class = estilo>
            <form action="dados_quantidade_entrada.php" method="POST">

                <center>
                    <br> <td>ENTRADA</td><br><br>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="nfe">
                                    ...
                                    $nfe = pg_query($conexao, "select id, numero_nota from entrada order by 2");

                                    while ($f = pg_fetch_array($nfe)) {
                                        echo "<option value='" . $f['id'] . "'>" . $f['numero_nota'] . "</option>";
                                    }
                                    ?>
